...
{p 4 4 2}
With {cmd:cbands}, {cmd:rd2d_dist} fills {cmd:CB_lower} and {cmd:CB_upper} in
...
{p 4 4 2}
After estimation, {cmd:rd2d_dist} prints a compact table with {cmd:Est.p},
{cmd:Se.p}, {cmd:Est.q}, {cmd:Se.q}, and pointwise confidence intervals for
each distance column. When {cmd:cbands} is requested, the printed table
focuses on {cmd:Est.q}, {cmd:Se.q}, pointwise confidence intervals, and
{cmd:CB.low}/{cmd:CB.high} uniform-band endpoints. Long distance-column labels
